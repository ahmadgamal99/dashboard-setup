    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __("Certificate data") . " : " . $certificate->name  }}</h3>
            </div>
            <!-- end   :: Card header -->
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-12 fv-row d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <x-dashboard.upload-image-inp name="logo" :image="$certificate->logo" directory="Certificates" placeholder="default.jpg" type="show" ></x-dashboard.upload-image-inp>
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="name_inp" name="name" value="{{ $certificate->name }}" placeholder="example" disabled/>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select disabled class="form-select" data-control="select2" name="category_id"  data-placeholder="{{ __("Choose the category") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                            <option value=""></option>
            ...
            <div class="form-footer">
                ...
                <a href="{{ route('dashboard.certificates.index') }}" class="btn btn-primary">
