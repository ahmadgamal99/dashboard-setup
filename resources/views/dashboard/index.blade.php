                ...
                <div class="card-header pt-5 mb-0">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--end::Amount-->
                            <!--begin::Currency-->
                            <span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">{{ __('SAR') }}</span>
                            <!--end::Currency-->
                        </div>
                        <!--end::Info-->
                        <!--begin::Subtitle-->
                    ...
                    <div class="symbol-group symbol-hover flex-nowrap">
                        @foreach($thisMonthClients->take(6) as $client)
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="{{ $client->name }}">
                                <img alt="Pic" src="{{ getImagePath( $client->image ) }}" />
                            </div>
                        @endforeach
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    ...
                    <div class="px-9 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <span class="fs-4 fw-semibold text-gray-400 me-1">{{ __('SAR') }}</span>
                        </div>
                        <!--end::Statistics-->
                    </div>
                    <!--end::Statistics-->
