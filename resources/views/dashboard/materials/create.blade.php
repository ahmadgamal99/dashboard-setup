...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.materials.index') }}" class="text-muted text-hover-primary">{{ __("Materials") }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.materials.store') }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.materials.index') }}">
            @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new material") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="unit_inp" name="unit" placeholder="example"/>
                    ...
                    <div class="row mb-8 justify-content-center" id="prices-container">
                        <div class="row w-75">
                            <div class="col-12 col-lg-5">
                                <div class="form-floating">
                                    <input type="number" min="1" class="form-control" id="prices_0_price_inp" name="prices[0][price]" placeholder="example"/>
                                    <label for="prices_0_price_inp">{{ __("Enter the price") }}</label>
                                </div>
                                <p class="invalid-feedback" id="prices_0_price"></p>
                            </div>
                            <div class="col-12 col-lg-5">
                                <div class="form-floating">
                                    <input type="text" class="form-control datepicker" id="prices_0_effective_date_inp" name="prices[0][effective_date]" placeholder="example"/>
                                    <label for="prices_0_effective_date_inp">{{ __("Choose effective date") }}</label>
                                </div>
                                <p class="invalid-feedback" id="prices_0_effective_date"></p>
                            </div>
