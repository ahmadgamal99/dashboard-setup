...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.vehicles-maintenance.index') }}" class="text-muted text-hover-primary">{{ __("Vehicles Maintenance") }}</a></h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __("Add new vehicle maintenance") }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.vehicles-maintenance.store') }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.vehicles-maintenance.index') }}">
            @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new vehicle maintenance") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="vendor_inp" name="vendor" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="kms_inp" name="kms" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="next_kms_inp" name="next_kms" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control datepicker" readonly id="valid_until_inp" name="valid_until" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <button class="btn btn-secondary w-100 file-upload-inp" type="button" style="height: 50.75px"> <i class="bi bi-upload fs-8" ></i> {{ __("no file is selected")   }} </button>
