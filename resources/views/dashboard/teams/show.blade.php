    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __("Location type data") . " : " . $team->description  }}</h3>
            </div>
            <!-- end   :: Card header -->
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" name="description" value="{{ $team['description'] }}" disabled placeholder="example"/>
            ...
            <div class="form-footer">
                ...
                <a href="{{ route('dashboard.teams.index') }}" class="btn btn-primary">
