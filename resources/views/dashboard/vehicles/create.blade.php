...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.vehicles.index') }}" class="text-muted text-hover-primary">{{ __("Vehicles") }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.vehicles.store') }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.vehicles.index') }}">
            @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new vehicle") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="color_inp" name="color" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="type_inp" name="type" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="brand_inp" name="brand" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="model_inp" name="model" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="year_inp" name="year" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control datepicker" readonly id="license_expiry_date_inp" name="license_expiry_date" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="license_plat_number_inp" name="license_plat_number" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <select class="form-select py-1" data-control="select2" name="contract_status" id="contract-status-sp" data-placeholder="{{ __("Choose the status") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" >
                                ...
                                <option value="0">{{ __('expired') }}</option>
                            </select>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control datepicker" readonly id="contract_start_date_inp" name="contract_start_date" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control datepicker" readonly id="contract_expiry_date_inp" name="contract_expiry_date" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control datepicker" readonly id="notify_on_inp" name="notify_on" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="gps_url_inp" name="gps_url" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="gps_username_inp" name="gps_username" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="gps_password_inp" name="gps_password" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="price_inp" name="price" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select py-1" data-control="select2" name="price_unit" id="price-unit-sp" data-placeholder="{{ __("Choose the price unit") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" >
                                <option></option>
                                <option value="kilometer" >{{ __( ucfirst("kilometer")) }}</option>
                                <option value="hour" >{{ __( ucfirst("hour")) }}</option>
                                <option value="day" >{{ __( ucfirst("day")) }}</option>
                            </select>
