    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __("Contractor data") . " : " . $contractor->name  }}</h3>
            </div>
            <!-- end   :: Card header -->
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="name_inp" name="name" value="{{ $contractor->name }}" placeholder="example" disabled/>
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="numeric" class="form-control" id="phone_inp" name="phone" value="{{ $contractor->phone }}" placeholder="example" disabled/>
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="numeric" class="form-control" id="email_inp" name="email" value="{{ $contractor->email }}" placeholder="example" disabled/>
            ...
            <div class="form-footer">
                ...
                <a href="{{ route('dashboard.contractors.index') }}" class="btn btn-primary">
