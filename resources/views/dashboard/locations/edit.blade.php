...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.locations.update',$location->id) }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.locations.index') }}">
            @method('PUT')
            @csrf
            <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Edit location data") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select py-1" data-control="select2" name="type_id" id="location-type-sp" data-placeholder="{{ __("Choose the type") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" >
                                ...
                                @foreach( $locationTypes as $locationType)
                                    <option value="{{ $locationType->id }}" {{ $locationType->id === $location->type_id ? 'selected' : '' }}> {{ $locationType->description }} </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="code_inp" name="code" value="{{ $location['code'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name" value="{{ $location['name'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="description_inp" name="description" value="{{ $location['description'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="phone" value="{{ $location['phone'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="address_inp" name="address" value="{{ $location['address'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="maps_url_inp" name="maps_url" value="{{ $location['maps_url'] }}" placeholder="example"/>
