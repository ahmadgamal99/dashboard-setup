<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto h-75px" id="kt_aside_logo">
        <!--begin::Logo-->
        <a class="navbar-brand mr-auto" href="{{ route('dashboard.index') }}">
            <img src="" class="h-25px logo"   alt="شعار ويب ستدي للبرمجيات حجم صغير ">
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                @canany(['view_products' , 'view_categories' , 'view_tags', 'view_attribute_categories'])
                ...
                @can('view_attribute_categories')
                    <div class="menu-item">
                        <a class="menu-link {{ isTabActive('attribute-categories') }}" href="{{ route('dashboard.attribute-categories.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                                <i class="fa fa-list"></i>
                        </span>
                        <span class="menu-title"> {{ __("Attribute Categories") }}</span>
                        </a>
                    </div>
                @endcan


                @canany(['view_reports' , 'view_orders' ])
                    <div class="menu-item mb-3">
                        <div class="menu-content pt-8 pb-0">
                ...
                @canany(['view_sliders' , 'view_users' , 'view_subscribers'])
                    <div class="menu-item mb-3">
                        <div class="menu-content pt-8 pb-0">
                ...
                @can('view_taxes')
                    <div class="menu-item">
                        <a class="menu-link {{ isTabActive('taxes') }}" href="{{ route('dashboard.taxes.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
