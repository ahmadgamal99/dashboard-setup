...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'date' => 'التاريخ',
        'type_id' => 'الفئة',
        'maps_url' => 'رابط خريطه جوجل',
        'photo_identification' => 'تعريف الشخصية',
        'category_id' => 'الفئة',
        'admin_id' => 'الموظف',
        'certificate_id' => 'الشهادة',
        'awarded_date' => 'تاريخ الحصول على الشهادة',
        'expiry_date' => 'تاريخ انتهاء الشهادة',
        'notify_on' => 'تاريخ التذكير',
        'cost' => 'التكلفة',
        'teams' => 'الفرق',
        'code' => 'الكود',
        'unit' => 'الوحدة',
        'groups' => 'المجموعات',
        'prices.*.price' => 'السعر',
        'prices.*.effective_date' => 'تاريخ النفاذ',
        'weight' => 'الوزن',
        'color' => "اللون",
        'type' => 'النوع',
        ...
        'license_plat_number' => "رقم لوحة المركبة",
        'contract_status' => 'حاله التعاقد',
        'contract_start_date' => "تاريخ بدايه التعاقد",
        'contract_expiry_date' => "تاريخ إنتهاء التعاقد",
        'gps_url' => "رايط نظام تحديد المواقع",
        'gps_status' => "حالة نظام تحديد المواقع",
        'gps_username' => "اسم المستخدم لنظام تحديد المواقع",
        'gps_password' => "كلمه المرور لنظام تحديد المواقع",
        'price_unit' => "وحدة قياس السعر",
        'vehicle_id' => 'المركبة',
        'vendor' => 'التاجر',
        'kms' => 'الكيلومترات',
        'next_kms' => 'الكيلومترات القادمة',
