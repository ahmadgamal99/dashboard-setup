                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `<div class="d-flex align-items-start">
                                    ...
                                    <a class="d-block overlay symbol-50px"  style="height:60px;" data-fslightbox="lightbox-basic" href="${getImagePath( row.main_image )}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                         style="height:60px;width:60px;border-radius:4px;margin:auto;background-image:url('${getImagePath(row.main_image)}');background-size:contain;">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
