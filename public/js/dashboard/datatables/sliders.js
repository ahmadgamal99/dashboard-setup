            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a class="d-block overlay" style="height:50px;" data-fslightbox="lightbox-basic" href="${getImagePath( data)}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                         style="height:56px;width:150px;border-radius:4px;margin:auto;background-image:url('${getImagePath(data)}');background-size:contain;">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
